#  Cool zookeeper simulation with a collection of animals by Neil Sharma
...
# The following commented-out code simply asks for the habitat # and returns the animal
# whereas the non-commented-out code loops the action of asking for a habitat # until the input is "exit".

# habitat = [camel, lion, deer, goose, bat, rabbit]
# habitat_number = int(input("Which habitat # do you need?"))
